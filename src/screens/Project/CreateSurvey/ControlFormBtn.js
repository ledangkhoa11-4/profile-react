...
import CheckboxSettingForm from '../CreatePoll/CheckBoxSettingForm';
        ...
        <div className="box-main-setting">
          <div className="row">
              <div className="col-xs-12 col-sm-12 col-md-8 col-lg-9">
                <CheckboxSettingForm
                  checkboxSetting={{
                    [INPUT_NAME.VIEW_RESULT]: props.fromState.surveyInfo[INPUT_NAME.VIEW_RESULT],
                    [INPUT_NAME.VIEW_SOCIAL]: props.fromState.surveyInfo[INPUT_NAME.VIEW_SOCIAL],
                  }}
                />
              </div>
                ...
                <div className="dropdown dropdown-action-poll-survey">
                    <div className="box-btn-launch-poll">
                      <a
                        ...
                        onClick={() => props.updateSurvey(APPROVED, props.isDisableEdit)}
                      >
                        {
                          props.isDisableEdit ?
                      ...
                      }
                      {
                        !props.isDisableEdit ?
                          <ul className="dropdown-menu">
                            ...
                            <li>
                              <a
                                onClick={() => props.updateSurvey(DRAFT, props.isDisableEdit)}
                              >
                  ...
                  >
                    <div className="main-modal-schedule-poll">
                      ...
                      <div className="btn-group row">
                          ...
                          <a
                            className="btn"
                            onClick={() => props.updateSurvey(SCHEDULED, props.isDisableEdit)}
                          >
                            {props.localeCreate.Button_Schedule}
                          </a>
                      </div>
